...
import 'package:townsquare/src/core/app/theme/fonts.dart';
...
final lightTheme = ThemeData(
  ...
  timePickerTheme: TimePickerThemeData(
    cancelButtonStyle: ButtonStyle(
      foregroundColor: WidgetStateProperty.all(AppColor.kWhite),
    ),
  ...
  scrollbarTheme: ScrollbarThemeData(
      thumbColor: WidgetStatePropertyAll(AppColor.kNeutral200)),
